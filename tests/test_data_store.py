...
def test_may_send_escalation():
    ...
    data_store.add_record(EventRecord(source_type='type1',
                                      escalated_at=None))
    ...
    data_store.add_record(EventRecord(source_type='type2',
                                      escalated_at=None))
...
def test_get_open_issues(*_):
    ...
    test_snooze_record = IgnoreFingerprintRecord(fingerprint='f1',
                                                 ignore_type=IgnoreFingerprintRecord.SNOOZE,
                                                 reported_at=datetime(2018, 2, 22, 0, 0, 11),
...
def test_remove_duplicate_events():
    ...
    one = EventRecord(received_at=datetime(2018, 2, 19, 0, 0, 11),
                      ...
                      data={})
    one.fingerprint = 'f1'
    two = EventRecord(received_at=datetime(2018, 2, 20, 0, 0, 11),
                      source_type='datastoretest',
                      owner='a',
                      data={})
    two.fingerprint = 'f2'
    three = EventRecord(received_at=datetime(2018, 2, 21, 0, 0, 11),
